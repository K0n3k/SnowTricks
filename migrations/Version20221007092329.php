 ...
 */
final class Version20221007092329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD group_id_id INT NOT NULL, ADD user_id_id INT NOT NULL, DROP group_id, DROP user_Id, CHANGE description description VARCHAR(255) NOT NULL, CHANGE published_Date published_date DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD group_id INT NOT NULL, ADD user_Id INT NOT NULL, DROP group_id_id, DROP user_id_id, CHANGE description description TEXT NOT NULL, CHANGE published_date published_Date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
