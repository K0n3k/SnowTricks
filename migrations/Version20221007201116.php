 ...
 */
final class Version20221007201116 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentary ADD user_id_id INT NOT NULL, ADD trick_id_id INT NOT NULL, DROP trick_id, DROP user_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentary ADD trick_id INT NOT NULL, ADD user_id INT NOT NULL, DROP user_id_id, DROP trick_id_id');
