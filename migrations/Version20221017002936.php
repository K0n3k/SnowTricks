 ...
 */
final class Version20221017002936 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE type type VARCHAR(255) NOT NULL, CHANGE trick trick_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE type type LONGTEXT DEFAULT \'\' NOT NULL COMMENT \'(DC2Type:simple_array)\', CHANGE trick_id trick INT NOT NULL');
