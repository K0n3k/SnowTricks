 ...
 */
final class Version20221007210431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE registration_token (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, token CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', UNIQUE INDEX UNIQ_D09D01D39D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE registration_token ADD CONSTRAINT FK_D09D01D39D86650F FOREIGN KEY (user_id_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE commentary CHANGE commentary commentary VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE registration_token DROP FOREIGN KEY FK_D09D01D39D86650F');
        ...
        $this->addSql('ALTER TABLE commentary CHANGE commentary commentary TEXT NOT NULL');
