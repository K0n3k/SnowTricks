 ...
 */
class getRegistrationTokenRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RegistrationTokenRepository' shared autowired service.
     *
     * @return \App\Repository\RegistrationTokenRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RegistrationTokenRepository.php';

        return $container->privates['App\\Repository\\RegistrationTokenRepository'] = new \App\Repository\RegistrationTokenRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
