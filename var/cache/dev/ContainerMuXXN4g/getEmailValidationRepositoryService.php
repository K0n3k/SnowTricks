 ...
 */
class getEmailValidationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmailValidationRepository' shared autowired service.
     *
     * @return \App\Repository\EmailValidationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmailValidationRepository.php';

        return $container->privates['App\\Repository\\EmailValidationRepository'] = new \App\Repository\EmailValidationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
