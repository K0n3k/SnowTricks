...
class __TwigTemplate_c1d9e409bd58dcda79237e3c4b558330 extends Template
{
    private $source;
    private $macros = [];
...
{% macro form_tree_details(name, data, forms_by_hash, show) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/form.html.twig", "E:\\Projets\\Openclassrooms\\P6_nguyenhuu_kevin\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\form.html.twig");
    }
}
